...
public class DungeonControllerLoader extends DungeonLoader {
    ...
    public DungeonControllerLoader(String filename)
        ...
        fswitchImage = new Image((new File("images/pressure_plate.png")).toURI().toString());
        treasureImage = new Image((new File("images/gold_pile.png")).toURI().toString());
        keyImage = new Image((new File("images/key.png")).toURI().toString());
        doorImage = new Image((new File("images/open_door.png")).toURI().toString());
        ghostImage = new Image((new File("images/gnome.png")).toURI().toString());
    }
    ...
    public void onLoad(FloorSwitch floorswitch) {
        ImageView view = new ImageView(fswitchImage);
